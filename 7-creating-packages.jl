...
Julia packages work quite differently than Python packages. They are a little bit more complicated to get started with, but simpler in the end.
...
Before we talk about building a packge, let's discuss "environments" which are like baby packages.
"""
...
# ╔═╡ 2d78658f-35bd-4752-9949-078fa147cb1c
md"""
## Packages

To make a Julia package, we create a simple file and folder structure.
