...
# ╔═╡ 6815410b-09c4-488d-96c5-65a56e23528b
using CairoMakie
...
# ╔═╡ f241e92b-a22b-450b-9d2e-c544c2820099
md"""
**===================================================================================**
...
# ╔═╡ 1196428e-b4de-4d19-9f6e-07a139c39824
md"""
...
# ╔═╡ 5cb0a183-9d53-46fd-893a-72a4377cfff9
md"""
...
# ╔═╡ c155dce5-4bda-4d36-be77-ce60ec459c2c
md"""
#### Bitwise Operators
...
# ╔═╡ 849cf946-71ac-4baa-9004-9e4b6f2c4086
md"""
#### Updating Operators
...
# ╔═╡ 371bfcd8-c9a4-42c0-843b-71a3ea927763
md"""
...
# ╔═╡ 8a4b7cac-5316-4982-8abb-fe971850da7a
md"""
...
# ╔═╡ 7ef6190e-29c2-45e4-8241-26dc6ad5be1e
...
Tasks can be created using the `@async`  macro.
...
md"""
This will immediately continue, and the task will launch asyncrhonously.
"""
...
# ╔═╡ 7a6e8394-6c8a-457c-9551-406761f1c034
md"""
!!! tip
	You can replace `@async` with `Threads.@spawn` to launch one or more individual tasks on background threads. They behave the same as tasks launched with `@async` but are free to run on any hardware thread.
"""

# ╔═╡ c3012b8f-a8d2-4058-b4d5-37d73591d61d
